    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item position-relative">
                <img src="Images/first.jpg" alt="HP" class="d-block w-100"  style="height:450px;">                
            </div>

            <div class="carousel-item active ">
                <img src="Images/asus.jpg" alt="Asus" class="d-block w-100"  style="height:450px;">
            </div>

            <div class="carousel-item">
                <img src="Images/slider2.jpg" alt="Dell" class="d-block w-100" style="height:450px;">
            </div>
        </div>
...
<!-- Category and Product contenct End Here -->
		  ...
		  <div class="mt-5 container"><hr></div>
        

<section class="container-fluid bg-white mt-3 p-5 ">
	<h4 class="container-fluid ml-5 font-weight-bold mt-3 ">Ready to embark on a journey through the future of laptops ? </h4><br>
	<p class=" container-fluid ml-5 font-weight-bold ">Click play now and unlock a world of unparalleled features and possibilities! Your ultimate laptop experience awaits.</p>
    <div class="d-flex align-items-center justify-content-center" style="overflow:hidden;">
        <iframe src="https://www.youtube.com/embed/fGrpes9EIgg" height="500" width="90%" frameborder="0" allowfullscreen></iframe>
    </div>
</section>
...
<!-- Our Products Start-->
  		<section class="container-fluid mt-5 bg-light p-5">
		    ...
		    <div class="row">		    	
		        <div class="col-md-12">
		            <h1 class="text-center font-weight-bold mt-5">We Sold All Brands Of Laptops</h1>
		        </div>
		    </div>
		    <div class="row mt-5">
		        <div class="col-md-12">
		            <div class="media border bg-white">
		                ...
		                <div class="col-md-2 mt-5">
		                    <img src="Images/e2.jpg" class="img-fluid" style="max-height: 80px;">
		                </div>
